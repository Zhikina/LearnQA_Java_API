...
public class ApiCoreRequests {
    @Step("Make a GET-request whith token and auth cookie")
    ...
    @Step("Make a GET-request whith auth cookie only")
    ...
    @Step("Make a GET-request whith token only")
    ...
    public Response makeDeleteRequestWithoutAuth(String url) {
        return given()
                .filter(new AllureRestAssured())
                .delete(url)
                .andReturn();
